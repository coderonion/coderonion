...
- ### Frameworks: [CUDA](https://developer.nvidia.com/cuda-zone), [Triton](https://github.com/triton-lang/triton), [TensorRT](https://developer.nvidia.com/tensorrt), [PyTorch](https://pytorch.org).
